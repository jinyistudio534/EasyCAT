...
class EasyCAT():            
    ...
    # for SB. Pico HAT Expansion
    # Cs=5, speed=12000000, Sck=2, Mosi=3, Miso=4
    # https://shop.sb-components.co.uk/products/raspberry-pi-pico-hat-expansion?srsltid=AfmBOopXYL6TSM-LNJi_GekF9J9dfLxkqjWYudZndExb9R7nVQHvux2P
    def __init__(self, Cs=5, speed=12000000, Sck=2, Mosi=3, Miso=4):   
        self.Operational = 0          
        ...
        #SPI.setRX(4);
        #SPI.setTX(3);        
        self.__spi = SPI(0, baudrate=speed, sck=Pin(Sck), mosi=Pin(Mosi), miso=Pin(Miso), firstbit = SPI.MSB)   
        self.Sync_ = ASYNC   
